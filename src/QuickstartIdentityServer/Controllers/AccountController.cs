...
using QuickstartIdentityServer.Helpers;
using QuickstartIdentityServer.models.Account;
        ...
        public async Task<IActionResult> ExternalLogin(string provider, string returnUrl)
        {
            ...
            if (AccountOptions.WindowsAuthenticationSchemes.Contains(provider))
            {
                ...
                if (HttpContext.User is WindowsPrincipal)
                {
                    ...
                    await HttpContext.Authentication.SignInAsync((string) IdentityServerConstants.ExternalCookieAuthenticationScheme, (ClaimsPrincipal) new ClaimsPrincipal(id), props);
